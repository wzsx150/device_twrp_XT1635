...
BOARD_CUSTOM_BOOTIMG_MK := device/twrp/XT1635/mkbootimg.mk
...
BOARD_MKBOOTIMG_ARGS := --kernel_offset 0x00008000 --ramdisk_offset 0x01000000 --tags_offset 0x00000100 --dt device/twrp/XT1635/dt.img
TARGET_PREBUILT_KERNEL := device/twrp/XT1635/kernel


TARGET_SPECIFIC_HEADER_PATH := device/twrp/XT1635/include
...
TW_DEFAULT_DEVICE_NAME := "Moto Z Play"
...
#TARGET_RECOVERY_FSTAB := device/twrp/XT1635/twrp.fstab
